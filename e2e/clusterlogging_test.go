...
func changeLoggingCollectorTest(t *testing.T, f *framework.Framework, ctx *framework.TestCtx, collector string) error {
	...
	t.Logf("exampleClusterLogging.Spec.Collection.Logs.Type = %s", exampleClusterLogging.Spec.Collection.Logs.Type)
	...
	t.Logf("NEW: exampleClusterLogging.Spec.Collection.Logs.Type = %s", exampleClusterLogging.Spec.Collection.Logs.Type)
